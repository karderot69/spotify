                  ...
                  <div class="contact-warp">
                     <div class="section-title mb-0">
                        ...
                        if (!isset($status) or $status != "not_exist") {
                           ...
                           <input type="text" style="width: 60%;" class="d-flex justify-content-center" name="key" placeholder="XXXX-XXXX-XXXX-XXXX" required></div>
                           </div><div align="center" style="padding-top:3%;" class="d-flex justify-content-center">
